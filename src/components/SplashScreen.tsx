    ...
    >
      ...
      <div
        ...
        style={{
          width: '320px',
          height: '320px',
          background: 'radial-gradient(circle, rgba(148,163,255,0.12) 0%, transparent 70%)',
          filter: 'blur(40px)',
      ...
      >
        <img
          src="/icon.svg"
          alt="Bíblia Alpha"
          style={{ width: '200px', height: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 0 32px rgba(148,163,255,0.35))' }}
          draggable={false}
        />
      </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-white/5">
        <div
          ...
          style={{
            ...
            transition: 'width 3.5s linear 0.2s',
          }}
        />
      </div>
